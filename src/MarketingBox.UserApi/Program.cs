...
namespace MarketingBox.UserApi
{
    public class Program
    {
        ...
        {
            Console.Title = "MarketingBox.UserApi";

            Settings = SettingsReader.GetSettings<SettingsModel>(SettingsFileName);

            using var loggerFactory = LogConfigurator.ConfigureElk_v2("MarketingBox.UserApi", Settings.SeqServiceUrl, Settings.ElkLogs);
